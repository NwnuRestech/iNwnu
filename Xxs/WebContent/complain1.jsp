<%@page import="com.xxs.dao.ComplaintDao"%>
<%@page import="com.xxs.dao.impl.ComplaintDaoImpl"%>
...
<div data-am-widget="intro" class="am-intro am-cf am-intro-default">
    ...
    <div style="width: 100%;height: 130px;padding: 5px 25px;" >
        <div style="height: 120px;width: 85%;float: left;border-radius: 18px;border:1px solid #bebebe;padding: 5px 10px;background-color: #ffdcb9">
            <a ><p>投诉商铺：${restname }</p>
            	<p>投诉人：${stuname }</p>
                <p>投诉时间：<fmt:formatDate value="${item.comp_time}" pattern="yyyy年MM月dd日HH点mm分" /></p>
                <p>投诉事件：${item.comp_event }</p>
...
<div class="fixed-btnword">
    <div id="wrapper">
        ...
        <div class="box">
            <div class="demo">
                <a href="javascript:;" class="bounceIn">我要投诉</a>
            </div>
