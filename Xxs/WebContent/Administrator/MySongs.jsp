...
<title>Insert title here</title>
	...
	<script type="text/javascript" src="${pageContext.request.contextPath }/easyui1545/jquery.easyui.min.js"></script>
        ...
        $(function () {
            $("#dg").datagrid({
                url: '${pageContext.request.contextPath }/MusicController?op=selectAllSongsIs0',
                rownumbers: true,
                fitColumns: true,
                singleSelect: true,
                pagination: true,
...
<body>
<table id="dg" title="点歌管理" style="width:1000px;height:365px"">
    <thead>
    <tr>
        <th data-options="field:'ck',checkbox:true" rowspan="2"></th>
        <th data-options="field:'song_id',width:50" rowspan="2">编码</th>
        <th data-options="field:'song_name',width:50" rowspan="2">歌名</th>
        <th data-options="field:'song_stu',width:50" rowspan="2">送给她</th>
        <th data-options="field:'song_time',width:100" rowspan="2">播放时间</th>
        <th data-options="field:'song_event',width:50" rowspan="2">留言</th>
        <th data-options="field:'song_state',width:50,align:'right'" rowspan="2">状态</th>
        <th colspan="2">操作</th>
    </tr>
    <tr>
