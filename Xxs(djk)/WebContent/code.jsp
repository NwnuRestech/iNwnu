...
<header data-am-widget="header" class="am-header am-header-default header">
    ...
    <h1 class="am-header-title"> <a href="#title-link" class="" style="color: #333;">取餐码</a></h1>
...
<div class="wrap" >
            <div align="center" style="height: 80px;color: #0b76ac;font-size: 2.5rem;margin-bottom: -20px; margin-top: 15px;">
                <p>取餐档口：${rest_name }</p>
            </div>
            <div class="c-com-btn-code" >
                <a >${indent_key }</a>
            </div>
        <div class="c-com-btn-time" >

           <a >取餐时间：${indent_data }</a>
        </div>
